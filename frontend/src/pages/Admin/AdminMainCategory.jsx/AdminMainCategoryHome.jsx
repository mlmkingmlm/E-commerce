...
function AdminMainCategoryHome() {
    ...
    function handleDelete() {
        dispatch(deleteMaincategory({ id: deleteId }))
    }
    ...
    const columns = [
        ...
        },
        {
            name: 'Image',
            cell: row => (
                <Link to={`${import.meta.env.VITE_SITE_IMG_SERVER}/${row.pic}`} target="_blank">
                    <img src={row.pic} width={50} height={50} alt="category" />
                </Link>
            )
        },
        {
        ...
        },
        {
            name: 'Edit',
            cell: row => (
                <Link to={`/admin/maincategory/update/${row._id}`}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-10">
                            ...
                            <h5 className='text-center text-light bg-dark p-2 fw-bold'>
                                Main Category
                                <Link to="/admin/maincategorycreate">
...
export default AdminMainCategoryHome